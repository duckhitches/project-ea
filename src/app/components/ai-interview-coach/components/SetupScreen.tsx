  ...
  return (
    <div className="min-h-full flex items-center justify-center p-6 sm:p-8 bg-white dark:bg-black text-black dark:text-white">
      <motion.div
        ...
        className="w-full max-w-md sm:max-w-lg border border-black dark:border-white/20 rounded-2xl p-6 sm:p-8 shadow-lg bg-white dark:bg-black/50 backdrop-blur-sm"
      >
        <motion.header
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="px-4 py-2.5 border border-black dark:border-white/30 rounded-lg bg-white dark:bg-black/50 text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white/50 disabled:opacity-40 transition-all duration-200"
          ...
          <motion.div variants={itemVariants}>
            ...
            <motion.textarea
              ...
              className="w-full min-h-[120px] px-4 py-2.5 border border-black dark:border-white/30 rounded-lg bg-white dark:bg-black/50 text-black dark:text-white placeholder-black/40 dark:placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white/50 focus:border-transparent font-mono resize-y transition-all duration-200"
              aria-label="Paste or review your resume text here"
              whileFocus={{ scale: 1.01 }}
              transition={{ type: "spring", stiffness: 300 }}
            />
            <motion.div
              className="mt-2 flex items-center justify-between text-xs text-black/60 dark:text-white/60"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="inline-flex rounded-lg border border-black dark:border-white/30 bg-white dark:bg-black/50 relative overflow-hidden">
              ...
              <button
                ...
                className={`relative px-4 py-2 rounded-l-lg focus:outline-none transition-colors duration-200 ${
              ...
              <button
                ...
                className={`relative px-4 py-2 rounded-r-lg focus:outline-none transition-colors duration-200 ${
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              type="submit"
              className="w-full px-5 py-2.5 bg-black text-white dark:text-black dark:bg-white rounded-lg font-semibold focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white/50 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
              disabled={!name || !role}
