...
const InterviewScreen: React.FC<InterviewScreenProps> = ({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col bg-white dark:bg-black/50 rounded-2xl border border-black dark:border-white/20 shadow-lg overflow-hidden w-full max-w-md sm:max-w-lg h-[540px] sm:h-[600px] mx-auto"
    >
      {/* Header */}
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="flex-shrink-0 flex justify-between items-center px-4 sm:px-5 py-2.5 border-b border-black/10 dark:border-white/10 bg-white/50 dark:bg-black/30 backdrop-blur-sm"
      >
          ...
          <AnimatePresence mode="wait">
            {isTimerVisible && (
              <motion.p
                ...
                className="font-mono text-lg text-black/70 dark:text-white/70 tracking-wider"
                aria-live="off"
                aria-atomic="true"
              >
        ...
        <motion.button
          ...
          className="p-2 text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white rounded-full focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black transition-colors"
      ...
      {/* Body */}
      <div className="flex flex-col flex-grow p-4 sm:p-5 md:p-6 overflow-hidden bg-gradient-to-b from-white/50 to-white dark:from-black/30 dark:to-black/50">
        <div
              ...
              >
                <motion.div
                  className={`max-w-[85%] sm:max-w-[70%] p-3 sm:p-4 rounded-2xl shadow-md border ${
                    isAI
                      ? "bg-white dark:bg-black/50 text-black dark:text-white border-black/10 dark:border-white/20 rounded-bl-none"
        ...
        >
          <AnimatePresence mode="wait">
            <motion.p
              ...
              exit={{ opacity: 0, y: 5 }}
              transition={{ duration: 0.2 }}
              className="text-black/60 dark:text-white/60 h-6 mb-2 sm:mb-3 text-sm font-medium"
              aria-live="polite"
            >
              {getStatusText()}
            </motion.p>
