        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Account Security Overview</h2>
            </div>
            <p className="text-sm text-gray-600 mb-6">Your account security status and recommendations</p>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 border-gray-200 focus:border-gray-900 focus:ring-0 rounded-lg pr-10"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Use a Strong Password</h3>
                  <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Regular Security Reviews</h3>
                  <p className="text-sm text-gray-600 mt-1">
