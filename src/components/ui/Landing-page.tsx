...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto font-mono transition-colors duration-300 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="relative mt-0 pt-12 sm:pt-16 md:pt-20 lg:pt-24 xl:pt-28 pb-12 sm:pb-16 md:pb-20 lg:pb-24 xl:pb-28">
          <div className="flex flex-col items-center justify-center h-full max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-black border-2 sm:border-4 border-black dark:border-white p-4 sm:p-6 md:p-8 lg:p-12 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)] mb-16 sm:mb-20 lg:mb-24 max-w-5xl mx-auto">
                ...
                <h1 className="mx-auto max-w-5xl text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-boldonse text-black dark:text-white uppercase tracking-tighter leading-tight mb-4 sm:mb-6">
                ...
                <motion.p
                  ...
                  className="mx-auto max-w-2xl py-4 sm:py-6 md:py-8 text-center text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 font-mono border-l-4 border-black dark:border-white pl-3 sm:pl-4 leading-relaxed break-words"
                >
                ...
                <motion.div
                  ...
                  className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-6 pt-6 sm:pt-8"
                >
                  <button
      ...
      {/* About Section */}
      <section id="about" className="relative py-12 sm:py-16 md:py-20 lg:py-24 border-t-2 sm:border-t-4 border-black dark:border-white bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            >
              ...
              <p className="text-black dark:text-white text-lg sm:text-xl md:text-2xl lg:text-3xl max-w-3xl mx-auto mt-4 sm:mt-6 font-boldonse uppercase leading-snug px-2">
          ...
          <div className="mt-16 sm:mt-24 lg:mt-32 p-4 sm:p-6 border-2 border-black dark:border-white bg-white dark:bg-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
            <About />
          </div>
        </div>
      </section>
