...
// Prepares raw microphone audio data (Float32Array) into the format expected by the Gemini Live API.
...
// Decodes raw PCM audio data from the API into an AudioBuffer for playback.
