...
export default function FeaturesSection() {
  return (
    <section className="py-12 sm:py-20 md:py-28 lg:py-32 bg-transparent font-montserrat">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-boldonse text-gray-900 dark:text-white mb-4 sm:mb-6 uppercase tracking-tighter leading-tight">
            Our{" "}
